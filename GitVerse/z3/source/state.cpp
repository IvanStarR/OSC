...
std::filesystem::path StateStore::pid_file(const std::string &name,
                                           const fs::path &run_dir) {
  return run_dir / (name + ".pid");
}
std::filesystem::path StateStore::status_file(const std::string &name,
                                              const fs::path &run_dir) {
